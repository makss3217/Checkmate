...
data class Knight(override val color: ChessColor) : ChessPiece{
    ...
    override fun getAvailableMoves(
        ...
        addCommandIfPositionAvailable(availableCommands, game, currentPosition,
            currentPosition.row + 2, currentPosition.column + 1)
        addCommandIfPositionAvailable(availableCommands, game, currentPosition,
            currentPosition.row + 2 , currentPosition.column - 1)
        addCommandIfPositionAvailable(availableCommands, game, currentPosition,
            currentPosition.row - 2, currentPosition.column + 1)
        addCommandIfPositionAvailable(availableCommands, game, currentPosition,
            currentPosition.row - 2, currentPosition.column - 1)
        addCommandIfPositionAvailable(availableCommands, game, currentPosition,
            currentPosition.row + 1, currentPosition.column + 2)
        addCommandIfPositionAvailable(availableCommands, game, currentPosition,
            currentPosition.row + 1, currentPosition.column - 2)
        addCommandIfPositionAvailable(availableCommands, game, currentPosition,
            currentPosition.row - 1, currentPosition.column + 2)
    ...
    override fun getPreview(): FigureImage {
        return if(this.color == ChessColor.BLACK) {
            FigureImage.BLACK_KNIGHT
        } else {
            FigureImage.WHITE_KNIGHT
        }
    }
}